...
class Day18Test {
    ...
    @Test
    fun `isInteriorPoint should return false if the point can reach the outside of the bounding box, given a potential point and a set of points`() {

        /*
        // looks like this, with a solid floor at z=0
        // and a ceiling with a hole in it at z=3
            XXXX
            X..X
            X..X
            XXXX
        ...
        val potentialPoint = Point3D(1,1,1)

        val result = isInteriorPoint(potentialPoint, points)
        assert(!result)
    }

    @Test
    fun `isInteriorPoint should return true if the point cannot reach the outside of the bounding box, given a potential point and a set of points`() {
        /*
        // looks like this, with a solid floor at z=0
